...
[LINK DE CÓDIGO](../programas/etiquetasBasicas.html)

¡Hola Developers! En esta lección veremos la segunda parte de la estructura de HTML, esteremos conociendo los diferentes elementos que podemos colocar dentro del `<body>`
...
~~~html
<a href="https://github.com/KarimeBonilla/Curso-FrontEnd-Intuitive" target="blank">Link a LaunchX</a>
    <br>
~~~
...
Eso es todo por esta lección, nos vemos en la [siguiente](./3.-elementosCompuestos.md).
